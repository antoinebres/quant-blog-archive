---
layout: post
title: donnees-externes-et-open-data-effet-de-mode-ou-reelle-valeur-ajoutee
date: 2023-06-06
url_wayback_machine: https://web.archive.org/web/20230606093704/https://www.quantmetry.com/blog/donnees-externes-et-open-data-effet-de-mode-ou-reelle-valeur-ajoutee/
---
Uncategorized 
...
[ ](http://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fwww.quantmetry.com%2Fblog%2Fdonnees-externes-et-open-data-effet-de-mode-ou-reelle-valeur-ajoutee%2F&title=Donn%C3%A9es%20externes%20et%20open%20data%20%3A%20effet%20de%20mode%20ou%20r%C3%A9elle%20valeur%20ajout%C3%A9e%20%3F "Linkedin") [ ](http://twitter.com/intent/tweet?text=Donn%C3%A9es%20externes%20et%20open%20data%20%3A%20effet%20de%20mode%20ou%20r%C3%A9elle%20valeur%20ajout%C3%A9e%20%3F&url=https%3A%2F%2Fwww.quantmetry.com%2Fblog%2Fdonnees-externes-et-open-data-effet-de-mode-ou-reelle-valeur-ajoutee%2F "Twitter") [ ](https://www.quantmetry.com/blog/donnees-externes-et-open-data-effet-de-mode-ou-reelle-valeur-ajoutee/ "Email") [ ](https://www.quantmetry.com/blog/donnees-externes-et-open-data-effet-de-mode-ou-reelle-valeur-ajoutee/ "Copy Link")

* * *

Temps de lecture : 5 minutes 

![Quantmetry.com : Données externes et open data : effet de mode ou réelle valeur ajoutée ?](https://quantmetry.b-cdn.net/wp-content/uploads/2018/03/open.jpg)
...
_« Notre volonté, c’est de supprimer les silos au sein de l’entreprise, exploiter et tirer de la valeur des données d’où qu’elles viennent : opérations, marketing, RH, … »_
...
En quelques mots, l’Open Data public fait référence – en France – à l’action du gouvernement de rendre ouvertes depuis 2011 un vaste ensemble de données libres d’utilisation. [ L’INSEE ](https://www.insee.fr/fr/statistiques) met par exemple à disposition des données macroéconomiques (principaux indicateurs économiques nationaux comme le chômage, la démographie, …) et microéconomiques (indicateurs de richesse à la maille communale comme le revenu) ; le gouvernement met à disposition des données dans des domaines aussi variés que l’agriculture, la culture, l’éducation, la santé, les territoires, et bien d’autres (voir [ le site officie ](https://www.data.gouv.fr/fr/) l). A titre d’exemple, ce sont quelques 220 jeux de données qui sont disponibles rien que pour la ville de Paris (voir les [ données disponibles ](https://opendata.paris.fr/page/home/) ). Le vivier est donc vaste. 

L’Open Data est aussi une pratique du secteur privé (ou semi-privé), puisqu’un grand nombre d’acteurs rendent leurs données accessibles (avec parfois certaines limitations); les réseaux sociaux ( [ Twitter ](https://developer.twitter.com/en/docs) , [ LinkedIn ](https://developer.linkedin.com/) , …), certaines banques comme [ BPCE ](https://bpce.opendatasoft.com/) , la [ Banque de France ](https://www.banque-france.fr/en/statistics/access-granular-data/open-data-room) ; ou encore des institutions comme [ Eurostat ](https://data.europa.eu/euodp/data/publisher/estat) , le [ FMI ](http://www.imf.org/en/Data) , [ l’OCDE ](https://data.oecd.org/) , … 
