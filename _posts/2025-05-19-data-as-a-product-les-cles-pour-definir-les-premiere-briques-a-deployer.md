---
layout: post
title: data-as-a-product-les-cles-pour-definir-les-premiere-briques-a-deployer
date: 2025-05-19
url_wayback_machine: https://web.archive.org/web/20250519123005/https://www.quantmetry.com/blog/data-as-a-product-les-cles-pour-definir-les-premiere-briques-a-deployer/
---
...
[ ](https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Fwww.quantmetry.com%2Fblog%2Fdata-as-a-product-les-cles-pour-definir-les-premiere-briques-a-deployer%2F "Linkedin") [ ](https://twitter.com/intent/tweet?text=Data%20as%20a%20Product%20%3A%20les%20cl%C3%A9s%20pour%20d%C3%A9finir%20les%20premi%C3%A8re%20briques%20%C3%A0%20d%C3%A9ployer&url=https%3A%2F%2Fwww.quantmetry.com%2Fblog%2Fdata-as-a-product-les-cles-pour-definir-les-premiere-briques-a-deployer%2F "Twitter") [ ](https://www.quantmetry.com/blog/data-as-a-product-les-cles-pour-definir-les-premiere-briques-a-deployer/ "Email") [ ](https://www.quantmetry.com/blog/data-as-a-product-les-cles-pour-definir-les-premiere-briques-a-deployer/ "Copy Link")

* * *

Auteurs : [ Gill Morisse ](https://www.linkedin.com/in/gillmorisse/) , [ Vlad Flamind ](https://www.linkedin.com/in/vflamind/) , [ Théo Vialard ](https://www.linkedin.com/in/th%C3%A9o-vialard-093708ab/)

Temps de lecture : 99 minutes 

![Quantmetry.com : Data as a Product : les clés pour définir les première briques à déployer](https://www.quantmetry.com/wp-content/uploads/2023/10/microsoftteams-image-4.png)
...
![](https://www.quantmetry.com/wp-content/uploads/2023/10/microsoftteams-image-2.png)

_Source: Adopting a product (vs a project) approach to data management, K2view, 2022_
...
_Pause lexicale : Data Product vs Data as a Product_
...
_Le Data as a Product encapsule et implémente tous les composants techniques et organisationnels nécessaires pour traiter et partager les données en tant que produit**.** _

![](https://www.quantmetry.com/wp-content/uploads/2023/10/data-as-a-product.png)
...
![](https://www.quantmetry.com/wp-content/uploads/2023/10/data-contract-stakeholders.png)
...
**Exemple de besoins**
  ...
  * **G** **agner en autonomie** dans l’ **ouverture des environnements** , **accès et** **_on-_ ** **_boarding_ ** outils, **bonnes pratiques** de développement 
  ...
  * Pourvoir réaliser une **demande de mise à disposition de nouvelles ressources** en terme de **puissance de calcul** et / ou **capacités de stockage** , et à terme pouvoir paramétrer mon espace ( _autoscaling_ ) moi-même. Attention : des **contrôles** devront être mis en place 
  * Disposer d’ **outils de labellisation** qui soient **collaboratifs** de sorte à permettre aux _data_ _scientists_ d’ **impliquer les métiers** dans ces activités lorsque cela est nécessaire (exemple donné de certains projets de _Computer Vision_ ) 
...
Le monitoring des _produits data_ est un prérequis au Self-Service, proposition de le faire davantage apparaitre, dès la vue haut niveau de l’offre de service. 
...
---|---|---|---  
** TECHNICIEN  ** |  **Requêter, préparer, modéliser** , tester et **vérifier** des hypothèses, **modéliser** les données et **construire** des visualisations avancées en **autonomie** afin **d’accélérer mes travaux** et me focaliser sur les tâches à forte valeur ajoutée.  |  Compétences en **programmation et développement d’algorithmes** (ex: python, java, scala, Spark, voire C++)  Application des **standards de développement associés** |  Experts en science des données ( _Data Scientists_ ) travaillant sur un SI métier  Ingénieurs IT / experts Data   
** ANALYSTE  ** |  Réaliser des **requêtes simples, analyser les données de manière avancée,** et formaliser efficacement les résultats à l’aide de **tableaux de bord & rapports interactifs ** pour résoudre des **problèmes métiers spécifiques** ou **alimenter les « explorateurs »** ( _ambition de passer d’une connaissance individuelle à une connaissance collective)_ |  Aptitude à comprendre les **significations métiers, les limites / les biais.** Maîtrise des **compétences basiques** ne nécessitant **pas ou peu de notions en programmation** |  Analyste de données   
...
** EXPLORATEUR  ** |  Explorer, manipuler et personnaliser les **_produits_ ** **préconstruits et disponibles** (tableaux de bords, rapports & jeux de données formatés, …) afin de **piloter des indicateurs** opérationnels et **orienter les décisions / actions** à leur niveau  |  Acculturés aux **enjeux relatifs à la donnée** : valeur métier, accessibilité, qualité, fiabilité,…  Connaissance avant tout **fonctionnelle / métier des données** |  Manager opérationnel  Opérationnels : Mainteneur / techniciens / …  Contrôleurs de gestion opérationnels  Responsable de domaine de données  CDO ( _Chief data_ _officer_ ) local  Responsable de données   
...
![](https://www.quantmetry.com/wp-content/uploads/2023/10/capture-decran-2023-10-25-a-095541.png)
...
![](https://www.quantmetry.com/wp-content/uploads/2023/10/capture-decran-2023-10-25-a-120414.png)

__

Il n’y a plus qu’à cadrer vos projets, les développer et les déployer ! 

_Contactez_ [ _Quantmetry_ ](mailto:communication@quantmetry.com) et nos experts [ Olivier Adriaens ](mailto:olivier.adriaens@capgemini.com) , _[ Gill Morisse ](mailto:gmorisse@quantmetry.com) , [ Jonathan Cassaigne ](mailto:jcassaigne@quantmetry.com) , [ Vlad Flamind ](mailto:vflamind@quantmetry.com) et [ Théo Vialard ](mailto:tvialard@quantmetry.com) _ _pour en savoir davantage sur notre approche de déploiement de Data as a Product et de construction de Data Products._
...
![Gill Morisse](https://www.quantmetry.com/wp-content/uploads/2023/10/gill-1-e1698250725408.jpeg)
...
![Vlad Flamind](https://www.quantmetry.com/wp-content/uploads/2023/10/1516330826388-2.jpeg)
