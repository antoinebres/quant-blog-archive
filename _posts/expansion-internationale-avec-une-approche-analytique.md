...
Wayback Machine URL: https://web.archive.org/web/20230129164541/https://www.quantmetry.com/blog/expansion-internationale-avec-une-approche-analytique/
...
[ ](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.quantmetry.com%2Fblog%2Fexpansion-internationale-avec-une-approche-analytique%2F "Facebook") [ ](http://twitter.com/intent/tweet?text=Expansion%20internationale%20avec%20une%20approche%20analytique&url=https%3A%2F%2Fwww.quantmetry.com%2Fblog%2Fexpansion-internationale-avec-une-approche-analytique%2F "Twitter")

* * *

Temps de lecture : 8 minutes 

![Quantmetry.com : Expansion internationale avec une approche analytique](https://quantmetry.b-cdn.net/wp-content/uploads/2017/10/shutterstock_431354935-900x444-1.jpg)

_Une entreprise ayant pour objectif de se développer à l’international doit avant tout bien comprendre les marchés étrangers qu’elle cherche à conquérir. Elle va alors obtenir de l’information granulaire et fiable sur les consommateurs ainsi que sur la concurrence présents dans ces contrées. La qualité des données et des analyses réalisées influence non seulement sa décision d’entrer sur ce nouveau marché, mais également le choix des produits ou encore l’adaptation de l’offre qui permettront son succès dans cette conquête._

_Cette collecte d’informations ne doit pas engendrer un coût trop important qui risquerait de mettre en péril le projet déjà risqué d’avancer sur de nouveaux marchés. Réalisée efficacement, elle peut au contraire créer un avantage compétitif._

_Nous sommes donc face à un défi considérable en particulier dans les cas des nouveaux marchés pour lesquels l’accès aux données est en train de se structurer._

_Nous illustrerons cette problématique avec un exemple d’outils déployé par Orange._
...
![](https://quantmetry.b-cdn.net/wp-content/uploads/2020/09/2-3.png)

Il y a quelques années, le groupe français Orange a décidé de collecter des données disponibles en ligne dans le cadre d’un projet visant à optimiser la valeur perçue de ses applications pour les smartphones et les tablettes. L’entreprise voulait mieux comprendre les comportements et les préférences des clients en employant des outils de pilotage quotidien du développement des applications d’Orange en Europe et en Afrique. Ce projet a été mené dans le contexte de la démocratisation des smartphones et tablettes et d’une croissance rapide de l’internet à haut débit. Ces appareils sont devenus très répandus grâce au boom des tablettes en 2010-1015 ainsi que la croissance rapide des ventes de smartphones. Dans beaucoup de pays, le temps passé sur les appareils mobiles a vite dépassé celui sur l’ordinateur de bureau (desktop). Cette popularité a stimulé le développement du marché des applications. Entre 2010 et 2015, Google, le fournisseur principal du système opérationnel pour les smartphones (Android) a vu le nombre d’applications disponibles sur Google Play monter de quelques dizaines de milliers à 1,5 million. Ce développement des services en ligne sans précédents a motivé Orange, détenteur d’un portefeuil d’applications considérable, à mieux comprendre les facteurs qui pouvaient influencer le comportement de ses clients afin de pouvoir adapter son offre sur les marchés étrangers. 
...
![](https://quantmetry.b-cdn.net/wp-content/uploads/2020/09/3-3.png)
...
![](https://quantmetry.b-cdn.net/wp-content/uploads/2020/09/5-2.png)

Illustration n°2 : L’outil de visualisation des résultats d’analyse (marché français) 

Les applications d’Orange et de ses principaux concurrents ont été comparées sur une matrice, selon deux critères : la note moyenne et le nombre de téléchargements (Illustration 2). De telles matrices ont été composées pour chaque pays ainsi que pour chaque catégorie d’applications (musique, communication, outils de base, etc.) 
